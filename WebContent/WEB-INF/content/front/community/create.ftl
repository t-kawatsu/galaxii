<title>コミュニティ登録</title>

<link href="${assets('community.css', 'css')}" media="screen, print" rel="stylesheet" type="text/css" >

<div class="clmn-left-main">
  <h1 class="icon-plus">コミュニティ登録</h1>
    <form class="community-create-form" action="${url('/community/create')}" method="POST">
...
1つのタグにつき登録できる最大文字数は10文字です。
        ...
        <div class="cm-info-right">
          <div class="clearfix">
	        ...
	        <h1 class="cm-title <@my.errorInputClass 'communityForm.title'/>"><@s.textarea name="communityForm.title" cssClass="cc-input form-textarea cancel-enter auto-resize-textbox char-counter" placeholder="タイトルを入力して下さい" /></h1>
