...
public class CreateAction extends AbstractAction {
	...
	@Action(value="user-watch/create-ajax/{userId}",
		results={
            @Result(name="success", location="user-watch/create-complete.ftl")
		}
	)
	@Override
    public String execute() throws Exception {
        ...
        userService.watchUser(myUser.getId(), user.getId());
        isUserWatched = true;
        
        // user info
        userInformationService.insertWatch(user, myUser);
		return SUCCESS;
    }
	
	@Action(value="user-watch/create-small-ajax/{userId}",
		results={
