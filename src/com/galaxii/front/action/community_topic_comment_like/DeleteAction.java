package com.galaxii.front.action.community_topic_comment_like;
...
public class DeleteAction extends AbstractAction {
	...
	@Resource
	private CommunityTopicCommentLikeDao likeDao;
	
	private Integer id;
	private Map<String, Object> uploadResultJson
		= new HashMap<String, Object>();

	@Action(value="community-topic-comment-like/delete-json/{id}",
		results={
    ...
    public String execute() throws Exception {
        ...
        // user info
        userInformationService.deleteCommunityTopicCommentLike(commentEntity, user);
		return SUCCESS;
    }
